...
class AnagramsTest {
	...
	public static Stream<Arguments> argumentsProvider() {
		return Stream.of(Arguments.arguments("a1bcd efg!h", "d1cba hgf!e"),
				Arguments.arguments("abc2f x34 !!@ 1fgr7", "fcb2a x34 !!@ 1rgf7"), Arguments.arguments("abcd", "dcba"),
				Arguments.arguments("&%$!5-*@", "&%$!5-*@"), Arguments.arguments("a", "a"),
				Arguments.arguments("aaaaa", "aaaaa"), Arguments.arguments("aaaaAAaaAaA", "AaAaaAAaaaa"),
				Arguments.arguments("ABC", "CBA"), Arguments.arguments("abc", "cba"), Arguments.arguments("!", "!"),
